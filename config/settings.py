...
MIDDLEWARE = [
    ...
    # добавлен слой для работы модуля django-keycloak-auth
...
# Конфигурация для django-keycloak-auth
# # Exempt URIS
# # For example: ['core/banks', 'swagger']
# KEYCLOAK_EXEMPT_URIS = []
# KEYCLOAK_CONFIG = {
#     'KEYCLOAK_SERVER_URL': 'http://localhost:8585/',
#     'KEYCLOAK_REALM': 'demo',
#     'KEYCLOAK_CLIENT_ID': 'backend',
#     'KEYCLOAK_CLIENT_SECRET_KEY': os.environ.get('CLIENT_SECRET_KEY',)
# }
